...
const StudentDashboardOverview = () => {
  return (
    <div className="flex flex-col gap-8 pb-8">
      <DashboardAnnouncements endpoint="/api/student/announcements" />
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-2 bg-gray-900 rounded-3xl p-8 text-white relative overflow-hidden flex flex-col justify-between shadow-xl">
          ...
          <div className="absolute left-1/2 bottom-0 w-48 h-48 bg-blue-500/20 rounded-full blur-3xl translate-y-1/2"></div>
