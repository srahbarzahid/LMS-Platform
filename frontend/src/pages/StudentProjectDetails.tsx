...
type SubmissionMethod = 'FILE' | 'URL' | 'TEXT';
...
const StudentProjectDetails = () => {
  ...
  const handleSubmit = () => {
    if ((submissionMethod === 'FILE' && !uploadedFile) || 
        (submissionMethod === 'URL' && !urlLink) || 
        (submissionMethod === 'TEXT' && !textSubmission)) {
    ...
    <div className="space-y-8 pb-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-8">
          ...
          {(currentStatus === 'Graded' || currentStatus === 'Resubmission Required') && (
            <div className={`rounded-3xl p-6 lg:p-8 text-white shadow-lg ${currentStatus === 'Graded' ? 'bg-gradient-to-br from-emerald-500 to-teal-600' : 'bg-gradient-to-br from-red-500 to-rose-600'}`}>
            ...
            <div className="p-6 lg:p-8">
              ...
              {(currentStatus === 'Pending' || currentStatus === 'Resubmission Required') ? (
                <>
                  ...
                  <div className="mb-6">
                    {submissionMethod === 'FILE' && (
                      <div>
                        {uploadedFile ? (
                          <div className="border border-border rounded-xl p-4 flex items-center justify-between bg-gray-50">
                          ...
                          <label className="border-2 border-dashed border-border rounded-2xl p-6 flex flex-col items-center justify-center text-center cursor-pointer hover:border-primary hover:bg-primary/5 transition-all">
                ...
                <div className="text-center py-4">
                  ...
                  {mockProjectData.submission.file && (
                    <div className="inline-flex items-center gap-2 bg-gray-50 border border-border px-4 py-2 rounded-lg text-sm font-medium mb-2 w-full truncate">
                  ...
                  {mockProjectData.submission.link && (
                    <div className="inline-flex items-center gap-2 bg-gray-50 border border-border px-4 py-2 rounded-lg text-sm font-medium w-full truncate">
