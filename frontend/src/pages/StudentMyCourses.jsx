...
const StudentMyCourses = () => {
  ...
  />
    ...
    /* Course Grid */
      ...
      {filteredCourses.length > 0 ? <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCourses.map((course) => <div key={course.courseId} className="bg-white rounded-3xl border border-border shadow-sm overflow-hidden flex flex-col group hover:shadow-lg transition-all duration-300 hover:border-primary/30">
    ...
    /* Thumbnail */
              ...
              <div className="relative aspect-video overflow-hidden">
                ...
                {course.status === "Completed" && <div className="absolute top-3 right-3 bg-emerald-500 text-white px-2.5 py-1 rounded-lg text-xs font-bold shadow-md">
                    Completed
                  </div>}
              </div>
  ...
  />
    ...
    /* Course Details Grid */
                  ...
                  <div className="grid grid-cols-2 gap-y-2 gap-x-4 mb-5 text-xs">
                    {course.lastWatchedLesson && <div className="col-span-2 flex items-start gap-2 text-body">
    ...
    /* Actions */
                  ...
                  <div className="pt-4 border-t border-border flex flex-col gap-3">
                    {course.status === "Not Started" && <button
  ...
  >
                    ...
                    {course.status === "In Progress" && <button
  ...
  >
    ...
    <div className="bg-white rounded-3xl border border-border p-12 text-center shadow-sm flex flex-col items-center justify-center">
          ...
          <p className="text-body max-w-md mx-auto mb-8">
            {searchQuery || categoryFilter !== "All Categories" || activeTab !== "All Courses" ? "We couldn't find any courses matching your filters. Try adjusting them to see more results." : "You haven't enrolled in any courses yet. Start your learning journey today!"}
          </p>
...
var stdin_default = StudentMyCourses;
export {
