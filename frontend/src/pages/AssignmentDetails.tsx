...
const AssignmentDetails = () => {
  ...
  // Local state to simulate submitting
    ...
    <div className="space-y-8 pb-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
            ...
            <div className="mb-10">
              ...
              <div className="bg-gray-50 rounded-2xl p-6 border border-border">
                <ul className="space-y-3">
                  {mockAssignmentData.objectives.map((obj, i) => (
          ...
          {mockAssignmentData.resources.length > 0 && (
            <div className="bg-white rounded-3xl p-6 lg:p-8 border border-border shadow-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {mockAssignmentData.resources.map(res => (
                  <div key={res.id} className="flex items-center justify-between p-4 rounded-2xl border border-border hover:border-primary/30 transition-colors group">
        ...
        <div className="lg:col-span-1 space-y-8">
          ...
          {currentStatus === 'Graded' && (
            <div className="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-3xl p-6 lg:p-8 text-white shadow-lg">
                    ...
                    {submissionMethod === 'FILE' && (
                      <div>
                        {uploadedFile ? (
                          ...
                          <label className="border-2 border-dashed border-border rounded-2xl p-8 flex flex-col items-center justify-center text-center cursor-pointer hover:border-primary hover:bg-primary/5 transition-all">
