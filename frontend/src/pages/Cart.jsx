...
const Cart = () => {
  ...
  return <div className="bg-[#f8f9fa] min-h-screen pt-32 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {cart.length === 0 ? <div className="bg-white p-12 rounded-3xl border border-border text-center shadow-sm">
            ...
            <div className="lg:col-span-2 space-y-4">
              <div className="bg-white rounded-2xl border border-border shadow-sm p-6 mb-4">
                <h3 className="font-bold text-heading text-lg mb-4">{cart.length} Course{cart.length !== 1 ? "s" : ""} in Cart</h3>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl border border-border shadow-sm p-6 sticky top-24">
                ...
                <div className="space-y-4">
                  <button className="w-full bg-primary text-white py-4 rounded-xl font-bold text-lg hover:bg-secondary transition-colors shadow-md shadow-primary/20 flex items-center justify-center gap-2">
