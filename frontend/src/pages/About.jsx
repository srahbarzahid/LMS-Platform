...
const About = () => {
  ...
  ].map((value, i) => <div key={i} className="bg-white p-8 rounded-3xl border border-border shadow-sm hover:-translate-y-2 hover:shadow-xl transition-all duration-300">
