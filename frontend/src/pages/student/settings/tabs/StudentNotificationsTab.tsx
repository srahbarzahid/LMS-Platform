...
const StudentNotificationsTab: React.FC = () => {
  ...
  const handleToggleCourseNotification = (key: keyof typeof courseNotifications) => {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    const payload: StudentNotificationPreferences = {
      emailNotifications,
      inAppNotifications,
      courseNotifications,
    };
...
export default StudentNotificationsTab;
