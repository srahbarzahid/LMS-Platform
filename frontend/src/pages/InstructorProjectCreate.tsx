...
import { ArrowLeft, UploadCloud, Calendar, FileText } from 'lucide-react';
    ...
    <div className="space-y-8 pb-8 max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-3xl p-6 lg:p-8 border border-border shadow-sm space-y-6">
        ...
        <div className="space-y-2">
          ...
          <textarea required rows={4} placeholder="Describe the project requirements..." className="w-full p-4 bg-gray-50 border border-border rounded-xl text-sm outline-none focus:border-primary transition-colors"></textarea>
        </div>
...
export default InstructorProjectCreate;
