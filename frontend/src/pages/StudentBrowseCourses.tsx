          ...
          <div className="flex-grow">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              ...
              {[1, 2, 3, 4, 5, 6].map(i => {
                ...
                return (
                <div key={i} className="bg-white rounded-2xl border border-border overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col group cursor-pointer hover:-translate-y-1 relative">
