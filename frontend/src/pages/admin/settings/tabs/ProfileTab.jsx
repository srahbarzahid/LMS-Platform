...
const ProfileTab = () => {
  ...
  return <form onSubmit={handleSaveProfile} className="space-y-8 animate-fade-in">
      <div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6">
          <div className="relative group">
            <div className="w-24 h-24 rounded-full overflow-hidden bg-primary/10 border-2 border-primary/20 flex items-center justify-center text-primary text-2xl font-bold">
              {currentAvatar ? <img src={currentAvatar} alt="Profile" className="w-full h-full object-cover" /> : <User className="w-10 h-10" />}
            </div>
