...
import { Building2, Upload, Trash2, Mail, Phone, Clock, Globe, Sun, Save, RefreshCw, ShieldAlert, BookOpen } from 'lucide-react';
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-xl border border-border bg-gray-50 flex items-center justify-center overflow-hidden shrink-0">
                {currentLogo ? (
                  <img src={currentLogo} alt="LMS Logo" className="w-full h-full object-contain p-1" />
                ) : (
