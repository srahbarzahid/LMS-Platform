  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Safety check to ensure we got JSON back and not an HTML fallback page
        ...
        // Massive Mock Data Fallback for Development
        setData({
          overview: { totalStudents: 15420, studentGrowth: 12.5, totalInstructors: 450, instructorGrowth: 5.2, totalCourses: 125, courseGrowth: 8.4, publishedCourses: 98, pendingApprovals: 12, totalRevenue: 3450000, revenueGrowth: 24.5, totalOrders: 18500, orderGrowth: 15.2, certificatesIssued: 8400, certificateGrowth: 18.0, averageCourseRating: 4.8, courseCompletionRate: 68 },
          userAnalytics: {
            totalActiveStudents: 12050, totalActiveInstructors: 410, newStudentRegistrations: 450, newInstructorAccounts: 15,
          ...
          revenueAnalytics: {
            todayRevenue: 45000, weeklyRevenue: 315000, monthlyRevenue: 1250000, totalRevenue: 3450000, averageOrderValue: 2500, revenueGrowth: 18.5,
            monthlyData: [ { month: 'Jan', revenue: 450000 }, { month: 'Feb', revenue: 520000 }, { month: 'Mar', revenue: 480000 }, { month: 'Apr', revenue: 610000 }, { month: 'May', revenue: 750000 }, { month: 'Jun', revenue: 980000 } ]
          },
          courseAnalytics: {
            published: 98, draft: 15, pending: 12, rejected: 3, featured: 10, topSelling: 5,
          ...
          enrollmentAnalytics: {
            total: 89000, today: 450, monthly: 12500, completed: 45000, activeLearners: 25000,
            monthlyData: [ { month: 'Jan', enrollments: 5000 }, { month: 'Feb', enrollments: 6200 }, { month: 'Mar', enrollments: 5800 }, { month: 'Apr', enrollments: 8100 }, { month: 'May', enrollments: 9500 }, { month: 'Jun', enrollments: 12500 } ]
          },
          paymentOverview: { successful: 18500, pending: 120, failed: 45, revenueThisMonth: 1250000 },
          ...
          topCourses: [
            { id: '1', name: 'Complete Web Dev Bootcamp', instructor: 'Sarah Drasner', students: 12500, revenue: 1500000, completionRate: 85, rating: 4.9, status: 'Active' },
            { id: '2', name: 'Advanced React Patterns', instructor: 'Kent C. Dodds', students: 8400, revenue: 950000, completionRate: 78, rating: 4.8, status: 'Active' },
            { id: '3', name: 'UI/UX Design Masterclass', instructor: 'Gary Simon', students: 6200, revenue: 620000, completionRate: 82, rating: 4.7, status: 'Active' }
          ],
          topInstructors: [
            { id: '1', name: 'Sarah Drasner', courses: 5, students: 25000, revenue: 3500000, rating: 4.9, status: 'Active' },
            { id: '2', name: 'Kent C. Dodds', courses: 3, students: 18000, revenue: 2100000, rating: 4.8, status: 'Active' }
          ],
          recentPayments: [
