    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-3xl border border-border shadow-sm">
          ...
          {invoice ? (
            <div className="space-y-4 bg-gray-50/50 p-5 rounded-2xl border border-border/50">
            ...
            <div className="text-center py-8 text-caption">No invoice generated for this payment.</div>
          )}
        </div>
      </div>
    </div>
