...
const AdminCourseDetails = () => {
  ...
  if (loading) {
    return <div className="p-8 flex items-center justify-center min-h-[60vh]"><div className="w-8 h-8 border-4 border-primary border-t-transparent rounded-full animate-spin" /></div>;
  }
  ...
  return <div className="p-8 pb-24">
    ...
    /* Header Profile */
      ...
      <div className="flex flex-col xl:flex-row gap-6 mb-8 bg-white p-6 md:p-8 rounded-3xl border border-border shadow-sm items-start xl:items-center">
        <div className="w-full xl:w-48 h-48 xl:h-32 rounded-2xl bg-gray-200 overflow-hidden flex-shrink-0 relative">
          ...
          {course.featured && <div className="absolute top-0 right-0 bg-yellow-400 px-3 py-1 rounded-bl-xl font-bold text-xs text-white flex items-center gap-1">
    ...
    /* Content */
      ...
      <div className="bg-white rounded-3xl border border-border shadow-sm p-6 md:p-8 min-h-[400px]">
        {activeTab === "overview" && <div className="max-w-4xl space-y-8">
            <div>
        ...
        {activeTab === "instructor" && <div className="max-w-2xl flex flex-col md:flex-row gap-8">
            ...
            <div className="p-6 rounded-2xl border border-border">
              ...
              <div className="flex items-center gap-4 mb-2">
                <div className="flex-1 h-3 bg-gray-100 rounded-full overflow-hidden">
                   <div className="h-full bg-primary rounded-full" style={{ width: `${course.analytics.completionRate}%` }} />
                </div>
        ...
        {activeTab === "reviews" && <div className="max-w-4xl space-y-4">
             {course.reviews.length === 0 ? <p className="text-caption">No reviews yet.</p> : course.reviews.map((review) => <div key={review.id} className="p-6 rounded-2xl border border-border">
        ...
        {activeTab === "activity" && <div className="max-w-2xl relative">
            ...
            <div className="space-y-8">
              {course.activityLog.map((log) => <div key={log.id} className="relative flex gap-6 pl-12">
    ...
    /* Reject Modal */
      ...
      {isRejectModalOpen && <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
  ...
  >
    ...
    /* Confirm Action Modal */
      ...
      {confirmAction && <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-md w-full p-8 shadow-2xl transform transition-all">
            <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-6 shadow-inner 
              ${confirmAction.type === "delete" ? "bg-red-100 text-red-600" : confirmAction.type === "unpublish" ? "bg-orange-100 text-orange-500" : "bg-emerald-100 text-emerald-600"}`}>
...
var stdin_default = AdminCourseDetails;
export {
