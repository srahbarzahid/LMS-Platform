...
const AdminCourseCertificates = () => {
  ...
  const handleAssign = (courseId, templateId) => {
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-border">
              {courses.map((course) => <tr key={course.id || course._id} className="hover:bg-gray-50/50 transition-colors">
  ...
  />
    ...
    className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg font-bold text-sm transition-colors ${isSaving[course.id || course._id] ? "bg-primary/50 text-white cursor-not-allowed" : "bg-primary hover:bg-primary/90 text-white"}`}
  >
...
var stdin_default = AdminCourseCertificates;
export {
