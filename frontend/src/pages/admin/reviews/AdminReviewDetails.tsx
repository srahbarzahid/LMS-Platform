...
import { 
  ArrowLeft, Star, User, BookOpen, 
  EyeOff, Eye, Trash2, Calendar, Mail, AlertTriangle
} from 'lucide-react';
        ...
        <div className="flex items-center gap-3">
          ...
          >
            {review.status === 'Published' ? (
              ...
              <><Eye className="w-4 h-4" /> Unhide Review</>
            )}
          </button>
          <button 
          ...
          <div className="bg-white p-6 rounded-xl border border-border shadow-sm h-full">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                {review.reviewTitle && (
                  <h3 className="text-xl font-bold text-heading mb-3">{review.reviewTitle}</h3>
                )}
