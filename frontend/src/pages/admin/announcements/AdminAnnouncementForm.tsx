...
import { 
  ArrowLeft, Save, Clock, Calendar, CheckCircle, Upload
} from 'lucide-react';
...
const AdminAnnouncementForm = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    audience: 'All Users',
    targetId: '', // For Specific Course/Student/Instructor
    message: '',
    priority: 'Medium',
  ...
  const handleActionClick = (publishOption: string) => {
        ...
        <div className="p-6 md:p-8 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {formData.audience.startsWith('Specific') && (
                <div>
