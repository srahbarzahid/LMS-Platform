...
const AdminCertificateVerification = () => {
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      {/* Results Section */}
      {error && (
        <div className="bg-red-50 border-2 border-red-100 rounded-2xl p-8 text-center animate-fade-in">
      ...
      {result && (
        <div className="bg-white rounded-2xl border-2 border-border shadow-lg overflow-hidden animate-fade-in">
          {/* Result Header */}
