...
const AdminEnrollmentDetails = () => {
  ...
  return (
    <div className="space-y-6">
        ...
        <div>
          <h1 className="text-2xl font-heading font-bold text-heading flex items-center gap-3">
            ...
            <span className={`text-xs px-2.5 py-1 rounded-full font-bold uppercase tracking-wider ${
              enrollment.status === 'Active' ? 'bg-indigo-50 text-indigo-700' :
      ...
      {progress && (
        <div className="bg-white p-8 rounded-3xl border border-border shadow-sm flex flex-col xl:flex-row items-center gap-10">
          ...
          <div className="border-t border-border/50 pt-6 mt-auto">
            <div className="flex items-center justify-between">
              ...
              <span className={`px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider ${
                enrollment.certificateStatus === 'Issued' ? 'bg-emerald-500 text-white shadow-md shadow-emerald-500/20' :
                enrollment.certificateStatus === 'Eligible' ? 'bg-yellow-400 text-yellow-900 shadow-md shadow-yellow-400/20' :
            ...
            {enrollment.certificateId && (
              <div className="flex items-center justify-between mt-3 bg-gray-50 p-3 rounded-xl border border-border/50">
