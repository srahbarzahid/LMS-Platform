  ...
  return <div className="space-y-8 pb-8">
    ...
    /* Left Column: Earned Certificates */
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {mockCertificates.length === 0 ? <div className="bg-white rounded-3xl p-12 border border-border border-dashed text-center">
            ...
            </div> : mockCertificates.map((cert) => <div key={cert.id} className="bg-white rounded-3xl overflow-hidden border border-border shadow-sm hover:shadow-md transition-shadow group flex flex-col sm:flex-row">
    ...
    /* Right Column: Progress */
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white rounded-3xl p-6 border border-border shadow-sm">
            {mockCoursesInProgress.length === 0 ? <p className="text-caption text-sm text-center">No courses currently in progress.</p> : <div className="space-y-6">
                {mockCoursesInProgress.map((course) => <div key={course.id}>
                    ...
                    <div className="w-full bg-gray-100 rounded-full h-2.5">
                      <div className="bg-primary h-2.5 rounded-full" style={{ width: `${course.progress}%` }} />
                    </div>
...
var stdin_default = StudentCertificates;
export {
