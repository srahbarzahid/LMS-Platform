...
import { CheckCircle2, Award, ExternalLink, AlertCircle } from 'lucide-react';
...
const VerifyCertificate = () => {
  ...
  // In a real app, we would fetch the certificate data from the backend using the ID
  // For the preview, we just match the mock ID or show invalid
