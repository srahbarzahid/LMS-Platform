...
const StudentProfile = () => {
  ...
  const StatCard = ({ icon: Icon, label, value, colorClass }) => <div className="bg-white rounded-2xl p-5 border border-border shadow-sm flex items-center gap-4">
  ...
  return <div className="max-w-7xl pb-8 space-y-6">
            ...
            <div className="flex items-end gap-6">
              <div className="relative group">
                <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full border-4 border-white bg-gray-100 flex items-center justify-center overflow-hidden">
                  {profile.avatarUrl ? <img src={profile.avatarUrl} alt="Avatar" className="w-full h-full object-cover" /> : <User className="w-12 h-12 text-gray-400" />}
                </div>
                {isEditing && <button className="absolute bottom-0 right-0 w-8 h-8 sm:w-10 sm:h-10 bg-primary text-white rounded-full flex items-center justify-center border-2 border-white hover:bg-primary/90 transition-colors">
          ...
          <div className="bg-white rounded-3xl p-6 lg:p-8 border border-border shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2 space-y-2">
                ...
                <textarea name="bio" value={profile.bio} onChange={handleChange} disabled={!isEditing} rows={4} className="w-full px-4 py-3 bg-gray-50 border border-border rounded-xl text-sm outline-none focus:border-primary disabled:opacity-70 resize-none" />
              </div>
            </div>
          </div>
...
var stdin_default = StudentProfile;
export {
