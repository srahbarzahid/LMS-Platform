...
interface InstructorNotificationPreferences {
...
const InstructorNotificationsTab: React.FC = () => {
  ...
  const handleToggleActivity = (key: keyof typeof studentActivityNotifications) => {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    const payload: InstructorNotificationPreferences = {
      emailNotifications,
      inAppNotifications,
      studentActivityNotifications,
    };
...
export default InstructorNotificationsTab;
