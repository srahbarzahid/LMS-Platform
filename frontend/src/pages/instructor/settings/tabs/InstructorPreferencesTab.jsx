...
const InstructorPreferencesTab = () => {
  ...
  const fetchPreferences = async () => {
    ...
    try {
      ...
      console.error("Failed to load instructor UI preferences:", err);
    } finally {
      setLoading(false);
    }
  };
  ...
  >
            <div className="flex justify-between items-start">
              ...
              {theme === "System" && <div className="w-6 h-6 rounded-full bg-primary text-white flex items-center justify-center">
                  <Check className="w-3.5 h-3.5" />
                </div>}
            </div>
            <div>
...
var stdin_default = InstructorPreferencesTab;
export {
