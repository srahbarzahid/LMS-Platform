  ...
  >
    ...
    /* Content Area */
        ...
        <div className="flex-1 p-6 md:p-8">
          ...
          {activeTab === "personal" && <div className="space-y-8 animate-fade-in">
              {
    /* Avatar Section */
  }
    ...
    /* Basic Info */
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea rows={4} defaultValue="I have over 10 years of experience in digital product design..." className="w-full px-4 py-3 bg-gray-50 border border-border rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all text-sm resize-none font-medium" />
    ...
    /* Social Links */
          ...
          {activeTab === "security" && <div className="space-y-8 animate-fade-in">
              <div>
...
var stdin_default = InstructorProfile;
export {
