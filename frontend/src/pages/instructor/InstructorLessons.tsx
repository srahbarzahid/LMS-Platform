...
import { 
  PlaySquare, UploadCloud, CheckCircle, 
  FileText, Settings2,
  ChevronRight, ChevronDown, ListTree,
  FileSignature, MonitorPlay, Save, Image as ImageIcon,
  Eye, Trash2
} from 'lucide-react';
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="flex items-center gap-3 pt-2">
                <div className="w-10 h-6 bg-gray-200 rounded-full relative cursor-pointer flex-shrink-0 transition-colors has-[:checked]:bg-primary">
                  ...
                  <div className="w-4 h-4 bg-white rounded-full absolute top-1 left-1 peer-checked:translate-x-4 transition-transform"></div>
                </div>
