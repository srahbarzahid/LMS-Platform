...
import { 
  ArrowLeft, Award, User, Book, Calendar, Mail,
  CheckCircle, Clock, Check, Activity, BarChart2
} from 'lucide-react';
...
const ProgressBar = ({ label, completed, total, color }: any) => {
...
const InstructorCertificateDetails = () => {
  ...
  if (error || !details) {
    return (
      <div className="max-w-7xl mx-auto space-y-6 pb-8 text-center pt-12">
    ...
    <div className="max-w-7xl mx-auto space-y-6 pb-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className={`px-4 py-2 rounded-xl text-sm font-bold flex items-center gap-2 ${
          details.certificateStatus === 'Issued' ? 'bg-green-100 text-green-700' :
          details.certificateStatus === 'Eligible' ? 'bg-blue-100 text-blue-700' :
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white p-6 rounded-2xl border border-border shadow-sm">
            ...
            {details.certificateStatus === 'Issued' && (
            ...
            {timeline.map((item: any, idx: number) => (
              <div key={idx} className="relative">
                <div className="flex items-center mb-1">
                  ...
                  `}>
                    {item.status === 'completed' ? <Check className="w-3 h-3" /> : <div className="w-2 h-2 rounded-full bg-white"></div>}
                  </div>
...
export default InstructorCertificateDetails;
