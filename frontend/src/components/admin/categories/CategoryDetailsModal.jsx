  ...
  return <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden">
        <div className="p-6 border-b border-border flex justify-between items-start bg-gray-50/50">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              {category.featured && <span className="px-2.5 py-1 rounded-full text-xs font-bold border bg-purple-50 text-purple-600 border-purple-200 flex items-center gap-1">
        ...
        <div className="p-6 overflow-y-auto flex-1 bg-white">
          ...
          {category.totalCourses === 0 ? <div className="text-center p-8 border border-dashed border-border rounded-xl">
              <div className="text-caption font-medium">No courses are currently assigned to this category.</div>
            </div> : <div className="border border-border rounded-xl overflow-hidden">
              <table className="w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-border">
                  {mockCourses.map((course) => <tr key={course.id} className="hover:bg-gray-50/50 transition-colors">
                      <td className="p-4">
                      ...
                      <td className="p-4">
                        <span className={`px-2 py-1 rounded-md text-xs font-bold ${course.status === "Published" ? "bg-emerald-50 text-emerald-600" : "bg-gray-100 text-gray-600"}`}>
                          {course.status}
                        </span>
                      </td>
                    </tr>)}
              ...
              {category.totalCourses > 5 && <div className="p-3 text-center border-t border-border bg-gray-50 text-sm font-medium text-caption">
...
var stdin_default = CategoryDetailsModal;
export {
