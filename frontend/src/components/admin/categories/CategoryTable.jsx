                  ...
                  <td className="p-4 text-right">
                    <div className="relative group inline-block">
                      ...
                      <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-border opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-10 flex flex-col py-2">
                        ...
                        <button onClick={() => onAction("view", row)} className="px-4 py-2 text-sm text-heading hover:bg-gray-50 font-medium text-left flex items-center gap-2">
                           <Eye className="w-4 h-4 text-blue-500" /> View Details
                        </button>
                        
                        <button onClick={() => onAction("edit", row)} className="px-4 py-2 text-sm text-heading hover:bg-gray-50 font-medium text-left flex items-center gap-2">
                           <Edit className="w-4 h-4 text-emerald-500" /> Edit Category
                        </button>
                        
                        <button onClick={() => onAction("toggleFeatured", row)} className="px-4 py-2 text-sm text-heading hover:bg-gray-50 font-medium text-left flex items-center gap-2">
                        ...
                        <button onClick={() => onAction("delete", row)} className="px-4 py-2 text-sm text-red-600 hover:bg-red-50 font-bold text-left flex items-center gap-2">
