...
const DraggableField = ({
  ...
  return <div
    ...
    className="group"
  >
      {fieldKey === "qrCode" ? <div className="w-full h-full border-2 border-gray-800 bg-white flex items-center justify-center">
        ...
        </div> : <span style={{ fontSize: `${fieldData.fontSize}px`, lineHeight: 1, whiteSpace: "nowrap" }}>
          [{fieldKey}]
        </span>}
...
const CertificateTemplateEditor = ({ backgroundUrl, fieldPositions, onChange }) => {
  ...
  return <div className="flex flex-col lg:flex-row gap-6 bg-gray-50 p-6 rounded-xl border border-border h-full overflow-hidden">
      {
    /* Visual Editor Area */
  }
  ...
  >
            {Object.entries(fieldPositions).map(([key, data]) => <DraggableField
    key={key}
    fieldKey={key}
    fieldData={data}
  ...
  />)}
          </div> : <div className="flex flex-col items-center justify-center text-gray-400 h-full w-full min-h-[300px]">
      ...
      <div className="w-full lg:w-80 bg-white p-5 rounded-lg border border-border shadow-sm flex flex-col gap-6 overflow-y-auto custom-scrollbar">
        <div>
          ...
          <div className="space-y-2 mb-6 max-h-48 overflow-y-auto pr-2">
            {Object.entries(fieldPositions).map(([key, data]) => <div
    key={key}
  ...
  >
        ...
        {selectedField && fieldPositions[selectedField] && <div className="space-y-4 pt-4 border-t border-border">
  ...
  />
                ...
                <div>
                  ...
                  <div className="flex rounded-md border border-border overflow-hidden">
                    {["left", "center", "right"].map((align) => <button
    key={align}
...
var stdin_default = CertificateTemplateEditor;
export {
