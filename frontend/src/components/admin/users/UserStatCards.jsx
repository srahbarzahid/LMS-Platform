const UserStatCards = ({ stats }) => {
  return <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    return <div key={index} className="relative overflow-hidden bg-white p-4 rounded-xl border border-border shadow-sm group hover:shadow-md hover:-translate-y-1 transition-all duration-300">
...
var stdin_default = UserStatCards;
export {
