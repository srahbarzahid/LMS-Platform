...
const CourseApprovalTable = ({
  ...
  return <div className="bg-white rounded-3xl border border-border shadow-sm overflow-hidden flex flex-col">
    ...
    /* Table Toolbar */
      ...
      <div className="p-6 border-b border-border bg-gray-50/50 dark:bg-[#18181b] flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        {
    /* Search */
  }
  ...
  />
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="text-sm">
            {data.length === 0 ? <tr>
              ...
              </tr> : data.map((row) => <tr key={row.id} className="border-b border-border/50 hover:bg-gray-50/50 dark:hover:bg-[#1a1a1d] transition-colors">
    ...
    /* Pagination */
      ...
      <div className="p-6 border-t border-border flex justify-between items-center bg-gray-50/50 dark:bg-[#18181b]">
...
var stdin_default = CourseApprovalTable;
export {
