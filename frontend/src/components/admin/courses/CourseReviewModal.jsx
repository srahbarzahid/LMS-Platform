...
const CourseReviewModal = ({ isOpen, onClose, course, onApprove, onReject }) => {
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <section>
                ...
                <div className="border border-border rounded-xl overflow-hidden divide-y divide-border">
                  {course.curriculum?.map((module, idx) => <div key={idx} className="bg-white">
                      <div
  ...
  >
                      ...
                      {expandedModule === idx && module.lessons && <div className="bg-gray-50/50 p-4 border-t border-border/50 animate-in slide-in-from-top-2 duration-200">
                          <div className="space-y-2 pl-11">
                            {module.lessons.map((lesson, lessonIdx) => <div key={lessonIdx} className="flex justify-between items-center p-3 bg-white border border-border rounded-lg shadow-sm">
                                <div className="flex items-center gap-3">
                                  {lesson.type === "video" ? <PlayCircle className="w-4 h-4 text-primary" /> : lesson.type === "quiz" ? <FileQuestion className="w-4 h-4 text-amber-500" /> : <FileText className="w-4 h-4 text-emerald-500" />}
    ...
    /* Right Column: Metadata & Actions */
            ...
            <div className="space-y-6">
              ...
              {isRejecting ? <div className="bg-red-50 p-5 rounded-2xl border border-red-100 shadow-sm animate-in fade-in slide-in-from-bottom-2">
...
var stdin_default = CourseReviewModal;
export {
