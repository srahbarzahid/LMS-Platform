...
const DashboardHeader = () => {
  ...
  return (
    <div className="bg-white p-6 rounded-3xl border border-border shadow-sm flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6 mb-8">
      {/* Welcome & Time Info */}
      <div>
