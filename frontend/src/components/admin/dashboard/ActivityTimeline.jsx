...
const ActivityTimeline = ({ activities }) => {
  ...
  return <div className="bg-white p-6 rounded-3xl border border-border shadow-sm flex flex-col h-full">
      ...
      <div className="relative border-l-2 border-gray-100 ml-4 space-y-6 flex-grow">
        {activities.map((activity) => <div key={activity.id} className="relative pl-6 group">
            {
    /* Timeline Dot */
  }
    ...
    /* Content */
            ...
            <div className="bg-gray-50 p-4 rounded-xl border border-border group-hover:border-primary/30 transition-colors">
              ...
              <p className="text-xs text-body mt-1">{activity.type.replace(/_/g, " ").replace(/\b\w/g, (l) => l.toUpperCase())}</p>
