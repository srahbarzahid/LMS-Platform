...
const ConfirmModal = ({
  ...
  >
          ...
          <button
    onClick={onConfirm}
    className={`flex-1 px-4 py-3 font-bold text-white rounded-xl transition-colors ${isDestructive ? "bg-red-600 hover:bg-red-700 shadow-sm" : "bg-primary hover:bg-primary/90 shadow-sm"}`}
  >
            {confirmText}
          </button>
        </div>
