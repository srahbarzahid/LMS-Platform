const validateStudentProfile = (req, res, next) => {
  ...
  if (gender !== void 0 && gender !== "" && !["Male", "Female", "Other", "Prefer not to say"].includes(gender)) {
...
const validateStudentNotifications = (req, res, next) => {
...
const validateStudentPreferences = (req, res, next) => {
