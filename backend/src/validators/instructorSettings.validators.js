const validateInstructorProfile = (req, res, next) => {
...
const validateInstructorNotifications = (req, res, next) => {
...
const validateInstructorPreferences = (req, res, next) => {
