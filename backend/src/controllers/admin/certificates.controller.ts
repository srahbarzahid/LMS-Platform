...
export const adminCertificatesController = {
  // --- TEMPLATES ---
  ...
  setDefaultTemplate: async (req: Request, res: Response) => {
    try {
  ...
  // --- ISSUED CERTIFICATES ---
  getIssuedCertificates: async (req: Request, res: Response) => {
    try {
  ...
  getIssuedCertificateById: async (req: Request, res: Response) => {
    try {
  ...
  revokeCertificate: async (req: Request, res: Response) => {
    try {
