...
import { mockAnnouncements } from './admin/announcements.controller';

export const userAnnouncementsController = {
  ...
  getInstructorAnnouncements: async (req: Request, res: Response) => {
    try {
  ...
  getPublicAnnouncements: async (req: Request, res: Response) => {
    try {
