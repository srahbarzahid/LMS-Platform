...
exports.adminCoursesController = {
    ...
    getCourses: async (req, res) => {
        try {
            ...
            if (search) {
                ...
                filtered = filtered.filter(c => c.title.toLowerCase().includes(lowerSearch) ||
    ...
    getPendingCourses: async (req, res) => {
        try {
            ...
            if (search) {
                const lowerSearch = search.toLowerCase();
                pending = pending.filter(c => c.title.toLowerCase().includes(lowerSearch) ||
                    c.instructor.name.toLowerCase().includes(lowerSearch));
            }
            // Calculate stats
            const stats = {
