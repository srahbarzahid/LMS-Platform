...
exports.adminEnrollmentsController = void 0;
// Mock Data Setup
...
exports.adminEnrollmentsController = {
    ...
    getEnrollments: async (req, res) => {
        try {
            ...
            // Global Search
            if (search) {
                filtered = filtered.filter(e => e.studentName.toLowerCase().includes(search) ||
            ...
            if (filters.course)
                filtered = filtered.filter(e => e.courseName.toLowerCase().includes(filters.course.toLowerCase()));
            if (filters.certStatus)
                filtered = filtered.filter(e => e.certificateStatus.toLowerCase() === filters.certStatus?.toLowerCase());
